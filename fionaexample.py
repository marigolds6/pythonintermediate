...
home = u'C:\\' #root drive you are reading from
shp = u'Assignment3\\PublicSchools.shp' #source shapefile, referenced from root
...
with fiona.open(shp) as source: #"r" mode is default.
    for feature in source:
        #Buffer distance is based on crs of feature
        feature['geometry'] = mapping(shape(feature['geometry']).buffer(5280.0)) #Treating fiona feature geometry as shapely shape, buffer 0 to fix invalid geometry and map back to geojson
